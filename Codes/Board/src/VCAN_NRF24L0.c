...
//uint8 TX_ADDRESS[5] = {0xE7, 0xE7, 0xE7, 0xE7, 0xE7};   // 定义一个静态发送地址
//uint8 RX_ADDRESS[5] = {0xE7, 0xE7, 0xE7, 0xE7, 0xE7};
uint8 TX_ADDRESS[5] = {0x01, 0x01, 0x10, 0x10, 0x01};   // 定义一个静态发送地址
uint8 RX_ADDRESS[5] = {0x01, 0x01, 0x10, 0x10, 0x01};
